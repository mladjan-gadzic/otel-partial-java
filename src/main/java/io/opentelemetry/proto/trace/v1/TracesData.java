...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              resourceSpans_ = new java.util.ArrayList<ResourceSpans>();
              mutable_bitField0_ |= 0x00000001;
            }
            resourceSpans_.add(
                input.readMessage(ResourceSpans.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TraceProto.internal_static_opentelemetry_proto_trace_v1_TracesData_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TraceProto.internal_static_opentelemetry_proto_trace_v1_TracesData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            TracesData.class, Builder.class);
  }

  public static final int RESOURCE_SPANS_FIELD_NUMBER = 1;
  private java.util.List<ResourceSpans> resourceSpans_;
  /**
   * <pre>
   ...
   */
  @Override
  public java.util.List<? extends ResourceSpansOrBuilder>
   ...
   */
  @Override
  public ResourceSpansOrBuilder getResourceSpansOrBuilder(
      int index) {
    return resourceSpans_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    TracesData other = (TracesData) obj;
  ...
  public static TracesData parseFrom(
  ...
  public static TracesData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static TracesData parseFrom(
  ...
  public static TracesData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static TracesData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static TracesData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(TracesData prototype) {
  ...
  public static final class Builder extends
    ...
    public TracesData getDefaultInstanceForType() {
      return TracesData.getDefaultInstance();
    }

    @Override
    public TracesData build() {
      TracesData result = buildPartial();
    ...
    public TracesData buildPartial() {
      TracesData result = new TracesData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof TracesData) {
        return mergeFrom((TracesData)other);
      } else {
    ...
    public Builder mergeFrom(TracesData other) {
      if (other == TracesData.getDefaultInstance()) return this;
      if (resourceSpansBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      TracesData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (TracesData) e.getUnfinishedMessage();
    ...
    private void ensureResourceSpansIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        resourceSpans_ = new java.util.ArrayList<ResourceSpans>(resourceSpans_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        ResourceSpans, ResourceSpans.Builder, ResourceSpansOrBuilder> resourceSpansBuilder_;
     ...
     */
    public Builder setResourceSpans(
        int index, ResourceSpans.Builder builderForValue) {
      if (resourceSpansBuilder_ == null) {
        ensureResourceSpansIsMutable();
     ...
     * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1;</code>
     */
    public Builder addResourceSpans(ResourceSpans value) {
      if (resourceSpansBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllResourceSpans(
        Iterable<? extends ResourceSpans> values) {
      if (resourceSpansBuilder_ == null) {
        ensureResourceSpansIsMutable();
     ...
     * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1;</code>
     */
    public ResourceSpans.Builder getResourceSpansBuilder(
        int index) {
    ...
    public ResourceSpans.Builder addResourceSpansBuilder() {
      return getResourceSpansFieldBuilder().addBuilder(
          ResourceSpans.getDefaultInstance());
    }
    /**
     * <pre>
     * An array of ResourceSpans.
    ...
    public ResourceSpans.Builder addResourceSpansBuilder(
        int index) {
      return getResourceSpansFieldBuilder().addBuilder(
          index, ResourceSpans.getDefaultInstance());
    }
    /**
     * <pre>
     * An array of ResourceSpans.
     ...
     * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1;</code>
     */
    public java.util.List<ResourceSpans.Builder>
         getResourceSpansBuilderList() {
      return getResourceSpansFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ResourceSpans, ResourceSpans.Builder, ResourceSpansOrBuilder>
        getResourceSpansFieldBuilder() {
      if (resourceSpansBuilder_ == null) {
  ...
  static {
    DEFAULT_INSTANCE = new TracesData();
  }
